...
This will add an infraction to your logging channel (if set) and is accessable using `+infractions <ID/Mention> [Page]`
The 'Page' argument is only needed, if a user has more than one page of infractions.
